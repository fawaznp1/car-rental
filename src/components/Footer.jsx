...
const Footer = () => {
  ...
  <small>
    ...
    <a 
      href="https://fawaznp.vercel.app/" 
      target="_blank" 
      rel="noopener noreferrer" 
      style={{ color: "white", textDecoration: "none", marginLeft: "5px", fontWeight: "bold" }}
    >
      
      @fawaz_np <i className="fas fa-external-link-alt" style={{ marginRight: "5px" }}></i>
    </a>
  </small>
</div>
